...
const DashedArrow = ({ className = "" }: { className?: string }) => (
  <div className={`flex items-center absolute z-0 ${className}`}>
    <div className="grow border-t-2 border-dashed border-gray-400 h-0"></div>
        ...
        <div className="max-w-7xl mx-auto border flex items-center justify-center h-150 w-full p-2">
          <div className="flex flex-row items-center gap-12 h-full">
            ...
            <div className="flex flex-col gap-8 relative">
              <div className="p-2 border flex items-center justify-center flex-col rounded-lg bg-white z-10 relative">
                <img
